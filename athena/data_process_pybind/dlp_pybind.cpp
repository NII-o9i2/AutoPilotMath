...
PYBIND11_MODULE(pybind_dlp, m) {
  ...
  py::class_<DLP::TensorD1<uint8_t>>(m, "TensorD1Uint8")
   ...
   py::class_<DLP::TensorD2<int8_t>>(m, "TensorD2int8")
      .def(py::init<>())
      .def(py::init<size_t, size_t>())
      .def("data", &DLP::TensorD2<int8_t>::data);
  ...
  py::class_<dlp::AgentOutputTensor>(m, "AgentOutputTensor")
      ...
      .def("get_agent_enc_mask_r2src_t", &dlp::AgentOutputTensor::get_agent_enc_mask_r2src_t)
      .def("get_agent_enc_mask_r2dst_t", &dlp::AgentOutputTensor::get_agent_enc_mask_r2dst_t)
      ...
      .def("get_agent_enc_mask_r2src_a2a", &dlp::AgentOutputTensor::get_agent_enc_mask_r2src_a2a)
      .def("get_agent_enc_mask_r2dst_a2a", &dlp::AgentOutputTensor::get_agent_enc_mask_r2dst_a2a)
      ...
      .def("get_dec_mask_r2src_t2m_multi", &dlp::AgentOutputTensor::get_dec_mask_r2src_t2m_multi)
      .def("get_dec_mask_r2dst_t2m_multi", &dlp::AgentOutputTensor::get_dec_mask_r2dst_t2m_multi)
      ...
      .def("get_dec_r_a2m_mask_r2src", &dlp::AgentOutputTensor::get_dec_r_a2m_mask_r2src)
      .def("get_dec_r_a2m_mask_r2dst", &dlp::AgentOutputTensor::get_dec_r_a2m_mask_r2dst)
      .def("get_dec_edge_index_a2m_multi", &dlp::AgentOutputTensor::get_dec_edge_index_a2m_multi)
      .def("get_dec_mask_r2src_a2m_multi", &dlp::AgentOutputTensor::get_dec_mask_r2src_a2m_multi)
      .def("get_dec_mask_r2dst_a2m_multi", &dlp::AgentOutputTensor::get_dec_mask_r2dst_a2m_multi)
      ...
      .def("get_dec_r_t2m_mask_r2src", &dlp::AgentOutputTensor::get_dec_r_t2m_mask_r2src)
      .def("get_dec_r_t2m_mask_r2dst", &dlp::AgentOutputTensor::get_dec_r_t2m_mask_r2dst)
      ...
      .def("get_dec_mask_r2src_m2m", &dlp::AgentOutputTensor::get_dec_mask_r2src_m2m)
      .def("get_dec_mask_r2dst_m2m", &dlp::AgentOutputTensor::get_dec_mask_r2dst_m2m)
      ...
      .def("get_agent_enc_mask_r2src_pl2a", &dlp::AgentOutputTensor::get_agent_enc_mask_r2src_pl2a)
      .def("get_agent_enc_mask_r2dst_pl2a", &dlp::AgentOutputTensor::get_agent_enc_mask_r2dst_pl2a)
      ...
      .def("get_dec_mask_r2src_pl2m_multi", &dlp::AgentOutputTensor::get_dec_mask_r2src_pl2m_multi)
      .def("get_dec_mask_r2dst_pl2m_multi", &dlp::AgentOutputTensor::get_dec_mask_r2dst_pl2m_multi)
      .def("get_valid_num", &dlp::AgentOutputTensor::get_valid_num)
      .def("get_ego_valid_mask", &dlp::AgentOutputTensor::get_ego_valid_mask)
      .def("get_ego_predict_mask", &dlp::AgentOutputTensor::get_ego_predict_mask)
      .def("get_ego_position", &dlp::AgentOutputTensor::get_ego_position)
      .def("get_ego_heading", &dlp::AgentOutputTensor::get_ego_heading)
      .def("get_ego_velocity", &dlp::AgentOutputTensor::get_ego_velocity)
      .def("get_ego_type", &dlp::AgentOutputTensor::get_ego_type)
      .def("get_ego_enc_x_e", &dlp::AgentOutputTensor::get_ego_enc_x_e)
      .def("get_ego_enc_num_t", &dlp::AgentOutputTensor::get_ego_enc_num_t)
      .def("get_ego_enc_mask_r2src_t", &dlp::AgentOutputTensor::get_ego_enc_mask_r2src_t)
      .def("get_ego_enc_mask_r2dst_t", &dlp::AgentOutputTensor::get_ego_enc_mask_r2dst_t)
      .def("get_ego_enc_r_t", &dlp::AgentOutputTensor::get_ego_enc_r_t)
      .def("get_ego_enc_num_pl2e", &dlp::AgentOutputTensor::get_ego_enc_num_pl2e)
      .def("get_ego_enc_r_pl2e", &dlp::AgentOutputTensor::get_ego_enc_r_pl2e)
      .def("get_ego_enc_mask_r2src_pl2e", &dlp::AgentOutputTensor::get_ego_enc_mask_r2src_pl2e)
      .def("get_ego_enc_mask_r2dst_pl2e", &dlp::AgentOutputTensor::get_ego_enc_mask_r2dst_pl2e)
      .def("get_ego_enc_num_a2e", &dlp::AgentOutputTensor::get_ego_enc_num_a2e)
      .def("get_ego_enc_r_a2e", &dlp::AgentOutputTensor::get_ego_enc_r_a2e)
      .def("get_ego_enc_mask_r2src_a2e", &dlp::AgentOutputTensor::get_ego_enc_mask_r2src_a2e)
      .def("get_ego_enc_mask_r2dst_a2e", &dlp::AgentOutputTensor::get_ego_enc_mask_r2dst_a2e)
      .def("get_ego_dec_num_t2m", &dlp::AgentOutputTensor::get_ego_dec_num_t2m)
      .def("get_ego_dec_r_t2m", &dlp::AgentOutputTensor::get_ego_dec_r_t2m)
      .def("get_ego_dec_r_t2m_mask_r2src", &dlp::AgentOutputTensor::get_ego_dec_r_t2m_mask_r2src)
      .def("get_ego_dec_r_t2m_mask_r2dst", &dlp::AgentOutputTensor::get_ego_dec_r_t2m_mask_r2dst)
      .def("get_ego_dec_num_t2m_multi", &dlp::AgentOutputTensor::get_ego_dec_num_t2m_multi)
      .def("get_ego_dec_mask_r2src_t2m_multi", &dlp::AgentOutputTensor::get_ego_dec_mask_r2src_t2m_multi)
      .def("get_ego_dec_mask_r2dst_t2m_multi", &dlp::AgentOutputTensor::get_ego_dec_mask_r2dst_t2m_multi)
      .def("get_ego_dec_num_a2m", &dlp::AgentOutputTensor::get_ego_dec_num_a2m)
      .def("get_ego_dec_r_a2m_mask_r2src", &dlp::AgentOutputTensor::get_ego_dec_r_a2m_mask_r2src)
      .def("get_ego_dec_r_a2m_mask_r2dst", &dlp::AgentOutputTensor::get_ego_dec_r_a2m_mask_r2dst)
      .def("get_ego_dec_num_a2m_multi", &dlp::AgentOutputTensor::get_ego_dec_num_a2m_multi)
      .def("get_ego_dec_mask_r2src_a2m_multi", &dlp::AgentOutputTensor::get_ego_dec_mask_r2src_a2m_multi)
      .def("get_ego_dec_mask_r2dst_a2m_multi", &dlp::AgentOutputTensor::get_ego_dec_mask_r2dst_a2m_multi)
      .def("get_ego_dec_num_pl2m_multi", &dlp::AgentOutputTensor::get_ego_dec_num_pl2m_multi)
      .def("get_ego_dec_r_pl2m", &dlp::AgentOutputTensor::get_ego_dec_r_pl2m)
      .def("get_ego_dec_mask_r2src_pl2m_multi", &dlp::AgentOutputTensor::get_ego_dec_mask_r2src_pl2m_multi)
      .def("get_ego_dec_mask_r2dst_pl2m_multi", &dlp::AgentOutputTensor::get_ego_dec_mask_r2dst_pl2m_multi)
      .def("get_ego_dec_num_m2m", &dlp::AgentOutputTensor::get_ego_dec_num_m2m)
      .def("get_ego_dec_mask_r2src_m2m", &dlp::AgentOutputTensor::get_ego_dec_mask_r2src_m2m)
      .def("get_ego_dec_mask_r2dst_m2m", &dlp::AgentOutputTensor::get_ego_dec_mask_r2dst_m2m);
  ...
  py::class_<dlp::MapTensorOutput>(m, "MapTensorOutput")
      ...
      .def("get_map_enc_mask_r2src_pt2pl", &dlp::MapTensorOutput::get_map_enc_mask_r2src_pt2pl)
      .def("get_map_enc_mask_r2dst_pt2pl", &dlp::MapTensorOutput::get_map_enc_mask_r2dst_pt2pl)
      ...
      .def("get_map_enc_mask_r2src_pl2pl", &dlp::MapTensorOutput::get_map_enc_mask_r2src_pl2pl)
      .def("get_map_enc_mask_r2dst_pl2pl", &dlp::MapTensorOutput::get_map_enc_mask_r2dst_pl2pl);
