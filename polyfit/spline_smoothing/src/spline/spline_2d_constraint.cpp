...
#include "spline_smoothing/include/math/math_utils.hpp"
#include "spline_smoothing/include/spline/spline_2d_constraint.hpp"

namespace PolyFit {

using PolyFit::math::Vec2d;
...
std::vector<double> Spline2dConstraint::AffineCoef(const double angle,
  ...
  double x_coef = -PolyFit::math::sin(PolyFit::math::Angle16::from_rad(angle));
  double y_coef = PolyFit::math::cos(PolyFit::math::Angle16::from_rad(angle));
...
double Spline2dConstraint::SignDistance(const Vec2d &xy_point,
  ...
  return PolyFit::math::InnerProd(
      xy_point.x(), xy_point.y(),
      -PolyFit::math::sin(PolyFit::math::Angle16::from_rad(angle)),
      PolyFit::math::cos(PolyFit::math::Angle16::from_rad(angle)));
}
