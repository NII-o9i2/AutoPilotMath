...
public:
  ...
  bool Add2dBoundary(const std::vector<double> &t_coord,
                     ...
                     const std::vector<PolyFit::math::Vec2d> &ref_point,
  ...
  bool
  Add2dDerivativeBoundary(const std::vector<double> &t_coord,
                          const std::vector<double> &angle,
                          const std::vector<PolyFit::math::Vec2d> &ref_point,
                          const std::vector<double> &longitudinal_bound,
                          const std::vector<double> &lateral_bound);
...
private:
  ...
  double SignDistance(const PolyFit::math::Vec2d &xy_point,
